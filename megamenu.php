    ...
    <div
      ...
      <ul class="mr-auto flex flex-row" data-te-navbar-nav-ref>
        ...
        <li class="static" data-te-nav-item-ref data-te-dropdown-ref>
          ...
          <div
            class="absolute left-0 top-full right-0 z-[1000] mt-0 hidden w-full border-none bg-white bg-clip-padding shadow-lg dark:bg-neutral-700 [&[data-te-dropdown-show]]:block"
              ...
              <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                <div>
                  ...
                  <a
                    ...
                    <div class="shrink-0">
                      <img
                      src="./resources/img/federalland.jpg"
                        class="w-20 rounded shadow-lg dark:shadow-black/10"
                        alt="Hollywood Sign on The Hill" />
                    </div>
                    <div class="ml-4 grow">
