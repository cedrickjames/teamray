    ...
    <div class="grid grid-cols-3 bg-red ">
        <div class="col-span-2 m-10">
            ...
            <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span
                    class="text-transparent bg-clip-text bg-gradient-to-r to-amber-600 from-gray-900">Description</span>
            </h1>
        ...
        <div class="col-span-1 ">
            ...
            <div
                ...
                <form class="space-y-6" action="#">
                    ...
                    <button type="submit"
                        class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send Message</button>
...
<h1 class="m-auto text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span
                    class="text-transparent bg-clip-text bg-gradient-to-r to-amber-600 from-gray-900">Gallery</span>
            </h1>
...
<video class="h-80" controls>
  ...
  <source src="../resources/vid/NPH.mp4" type="video/mp4">
...
<section class="overflow-hidden text-neutral-700 text-center">
<h1 class="m-auto text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span
                    class="text-transparent bg-clip-text bg-gradient-to-r to-amber-600 from-gray-900">Related Properties</span>
            </h1>
  <div class=" mx-auto px-8 py-2 lg:px-8 lg:pt-10">
