  ...
  <div class="px-2  sm:px-6  py-12 md:px-12 bg-white text-gray-800 text-center lg:text-left">
    <div class="container mx-auto xl:px-32">
      <div class="grid lg:grid-cols-2 gap-12 flex items-center">
        ...
        <h1 class="text-xl font-bold tracking-tight text-gray-600 sm:text-xl">RENTING FOR LANDLORDS</h5>
        <br>
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Lease out your</h1>
        <h1 class="text-4xl font-bold tracking-tight text-amber-700 sm:text-6xl">property in a snap.</h1>

        <p class="mt-6 text-lg leading-8 text-gray-600">Leasing out your property doesn’t have to be stressful. Let our agents make it easy for you.</p>
  ...
  <div class="px-2  sm:px-6  py-12 md:px-12 bg-white text-gray-800 text-center lg:text-left">
    <div class="container mx-auto xl:px-32">
      ...
      <div  data-aos="fade-down" class="mx-2 sm:mx-0 mb-12 lg:mb-0">
        ...
        <div data-aos="fade-right" class="mt-12 lg:mt-0 ">
        <h1 class="text-xl font-bold tracking-tight text-amber-600 sm:text-xl">AN EFFICIENT DATABASE</h5>
        <br>
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Find tenants safe and fast.</h1>

        <p class="mt-6 text-lg leading-8 text-gray-600">Get your property safely listed within minutes. Enjoy the benefits of our online ecosystem for maximum exposure—with no hidden fees!</p>
          <!-- <a class="inline-block px-7 py-3 bg-transparent text-blue-600 font-medium text-sm leading-snug uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#!" role="button">Buy a home</a> -->
  ...
  <div class="px-2  sm:px-6  py-12 md:px-12 bg-white text-gray-800 text-center lg:text-left">
    <div class="container mx-auto xl:px-32">
      ...
      <div  data-aos="fade-down" class="block sm:hidden mx-2 sm:mx-0 mb-12 lg:mb-0">
        ...
        <div data-aos="fade-right" class="mt-12 lg:mt-0 ">
        <h1 class="text-xl font-bold tracking-tight text-amber-600 sm:text-xl">AGGRESSIVE MARKETING</h5>
        <br>
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Your home is in the right place</h1>

        <p class="mt-6 text-lg leading-8 text-gray-600">Apart from listing your property on our site, we even advertise on leading platforms like Google and Facebook.</p>
          <!-- <a class="inline-block px-7 py-3 bg-transparent text-blue-600 font-medium text-sm leading-snug uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#!" role="button">Buy a home</a> -->
