  ...
  <!-- <nav class="navbar navbar-expand-lg shadow-md py-4 bg-white relative flex items-center w-full justify-between">
    <div class="px-6 w-full flex flex-wrap items-center justify-between">
      <div class="flex items-center">
        ...
        <a class="navbar-brand text-blue-600" href="#home">
...
<div class="container my-2 px-6 mx-auto">
  ...
  <!-- Section: Design Block -->
  <section class="mb-8 text-gray-800 text-center md:text-left">
...
<!-- latest -->
<div class="container py-24 my-24 px-6 mx-auto" id="latest">
...
<div class="container py-24 my-24 px-6 mx-auto" id="services">
...
<div class="container py-10 my-10 px-6 mx-auto" id="contact">
